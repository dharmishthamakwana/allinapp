...
class BottomProvider extends ChangeNotifier {
  ...
  List<BottomModel> videoApp = [
    ...
    BottomModel(
        name: "Netflix",
        image: "assets/image/netflix.jpg",
        url: "https://www.netflix.com/in/"),
    BottomModel(
        name: "Sony LIV",
        image: "assets/image/sony_liv.jpg",
        url: "https://www.sonyliv.com/"),
    BottomModel(
        name: "Amazon Prime",
        image: "assets/image/amazon_prime.jpg",
        url: "https://www.primevideo.com/"),
  ];
  List<BottomModel> socialApp = [
    BottomModel(
        name: "WhatsApp",
        image: "assets/image/whatsapp.jpg",
        url: "https://www.whatsapp.com/"),
    BottomModel(
        name: "Instagram",
        image: "assets/image/instagram.jpg",
  ...
  List<BottomModel> newsApp = [
    BottomModel(
        name: "Divya Bhaskar",
        image: "assets/image/divya_bhasakr.jpg",
        url: "https://www.divyabhaskar.co.in/"),
    BottomModel(
        name: "Aaj Tak",
        image: "assets/image/aaj_tak_.png",
        url: "https://www.aajtak.in/"),
    BottomModel(
        name: "Zee News",
        image: "assets/image/zee_news.png",
        url: "https://zeenews.india.com/"),
    BottomModel(
        name: "Google News",
        image: "assets/image/google_news.jpg",
  ...
  List<BottomModel> shoppingApp = [
    ...
    BottomModel(
        name: "FlipKart",
        image: "assets/image/flipcard.png",
        url: "https://www.flipkart.com/"),
    BottomModel(
        name: "Meesho",
        image: "assets/image/meesho.jpg",
  ...
  List<BottomModel> educationApp = [
    BottomModel(
        name: "Programiz",
        image: "assets/image/programiz.png",
        url: "https://www.programiz.com/"),
    BottomModel(
        name: "W3Schools",
        image: "assets/image/w3schools.jpg",
        url: "https://www.w3schools.com/"),
    BottomModel(
        name: "JavatPoint",
        image: "assets/image/javatpoint.png",
        url: "https://www.javatpoint.com/"),
    BottomModel(
        name: "TutorialsPoint",
        image: "assets/image/tutorialspoint.png",
